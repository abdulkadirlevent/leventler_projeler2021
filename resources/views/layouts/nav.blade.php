                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('caris.index') }}">Caris</a>
                            @endcan
                            @can('view-any', App\Models\Projeler::class)
                            <a class="dropdown-item" href="{{ route('projelers.index') }}">Projelers</a>
                            @endcan
                            @can('view-any', App\Models\Tesisatlar::class)
                            <a class="dropdown-item" href="{{ route('tesisatlars.index') }}">Tesisatlars</a>
                            @endcan
                        </div>
